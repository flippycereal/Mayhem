...
public class AngelicFireEnchantment extends Enchantment {
    public AngelicFireEnchantment(Rarity rarity, EquipmentSlot... slotTypes) {
    ...
    protected boolean canAccept(Enchantment other) {
        return super.canAccept(other) && other != ModEnchantments.ANGELIC_DASH;
    }
}
